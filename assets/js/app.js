...
function closeModal(event) {
    if (!event || event.target === uploadModal || event.target.getAttribute('onclick')) {
...
window.closeModal = function(event) {
    ...
    document.getElementById('file-label').textContent = "Toca para Tomar Foto o Elegir de Galería";
};